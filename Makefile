...
config: ./syscfg ./conf
	...
	sh ./syscfg -s ./conf -- ./src/_hostname
	sh ./syscfg -s ./conf -- ./src/_hosts
	sh ./syscfg -s ./conf -- ./src/_initramfs_conf
	sh ./syscfg -s ./conf -- ./src/_kvantum_conf
	sh ./syscfg -s ./conf -- ./src/_locale
	sh ./syscfg -s ./conf -- ./src/_makepkg_conf
	sh ./syscfg -s ./conf -- ./src/_mpv_conf
	sh ./syscfg -s ./conf -- ./src/_mutt_conf
	sh ./syscfg -s ./conf -- ./src/_nano_conf
	sh ./syscfg -s ./conf -- ./src/_openal_conf
	sh ./syscfg -s ./conf -- ./src/_pacman_conf
	sh ./syscfg -s ./conf -- ./src/_pam_conf
	sh ./syscfg -s ./conf -- ./src/_pipewire_conf
	sh ./syscfg -s ./conf -- ./src/_pipewire_media_session_conf
	sh ./syscfg -s ./conf -- ./src/_ranger_conf
	sh ./syscfg -s ./conf -- ./src/_resolv_conf
	sh ./syscfg -s ./conf -- ./src/_sh
	sh ./syscfg -s ./conf -- ./src/_sudo_conf
	sh ./syscfg -s ./conf -- ./src/_sway_conf
	sh ./syscfg -s ./conf -- ./src/_swayimg_conf
